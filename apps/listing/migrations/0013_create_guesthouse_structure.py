    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(models.Q(('individual_owner__isnull', False), ('company__isnull', True)), models.Q(('individual_owner__isnull', True), ('company__isnull', False)), _connector='OR'),
